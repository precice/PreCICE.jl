...
function setMeshVertices(meshID::Integer, positions::AbstractArray{Float64})
    ...
    ccall((:precicec_setMeshVertices, libprecicePath), Cvoid, (Cint, Cint, Ref{Cdouble}, Ref{Cint}), meshID, _size, reshape(positions,:), vertexIDs)
    return vertexIDs 
end
...
function getMeshVertexIDsFromPositions(meshID::Integer, positions::AbstractArray{Float64})
    ...
    ccall((:precicec_getMeshVertexIDsFromPositions, libprecicePath), Cvoid, (Cint, Cint, Ref{Cdouble}, Ref{Cint}), meshID, _size, reshape(positions,:), ids)
    return ids
end
...
function writeBlockVectorData(dataID::Integer, valueIndices::AbstractArray{Cint}, values::AbstractArray{Float64})
    ...
    ccall((:precicec_writeBlockVectorData, libprecicePath), Cvoid, (Cint, Cint, Ref{Cint}, Ref{Cdouble}), dataID, _size, valueIndices, reshape(values,:))
end
